...
from transformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLTextConfig                                            
from transformers.models.qwen2_vl.modeling_qwen2_vl import Cache                                                        
from transformers.models.qwen2_vl.modeling_qwen2_vl import FlashAttentionKwargs                                         
from transformers.models.qwen2_vl.modeling_qwen2_vl import Unpack                                                       
from transformers.models.qwen2_vl.modeling_qwen2_vl import ALL_ATTENTION_FUNCTIONS                                      
from transformers.models.qwen2_vl.modeling_qwen2_vl import eager_attention_forward                                      
from transformers.models.qwen2_vl.modeling_qwen2_vl import apply_multimodal_rotary_pos_emb                              
from transformers.models.qwen3_vl.modeling_qwen3_vl import apply_rotary_pos_emb                                         
# from transformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLTextRMSNorm                                         
...
class self_Qwen2VLTextAttention(nn.Module):                                                                             
    """                                                                                                                 
    ...
    def __init__(self, model):                                                                                          
        ...
        self.num_key_value_heads = model.num_key_value_heads                                                            
        self.num_key_value_groups = model.num_key_value_groups                                                          
        self.is_causal = model.is_causal                                                                                
        self.attention_dropout = model.attention_dropout                                                                
        self.rope_parameters = model.rope_parameters                                                                    
        ...
        self.sliding_window = model.sliding_window                                                                      
    ...
    def forward(                                                                                                        
        ...
        **kwargs: Unpack[FlashAttentionKwargs],                                                                         
        ...
        self.plot_multimodal_attention_28_heads(attn_weight_2, self.vision_mask,None)                                   
    ...
    def plot_multimodal_attention_28_heads(self,attn_weights, vision_mask, text_mask):                                  
        """                                                                                                             
        ...
        import os                                                                                                       
        os.makedirs(f"z_attention_comparison_qwen2/{self.data_num}", exist_ok=True)                                     
                                                                                                                        
        output_path =  get_next_filename(f"z_attention_comparison_qwen2/{self.data_num}")                               
