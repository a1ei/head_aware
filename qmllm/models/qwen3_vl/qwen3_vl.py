...
@MODEL_REGISTRY.register("qwen3_vl") 
class Qwen3_VL(BaseModel):  
    ...
    def forward(
        ...
        **kwargs
        ...
        if labels is not None:
            loss = self.model.loss_function(logits=logits, labels=labels, vocab_size=self.model.config.text_config.vocab_size)
