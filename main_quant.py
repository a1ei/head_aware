...
def parse_quant_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="qwen3_vl", help="Name of model e.g. `hf`") #internvl2 ，qwen3_vl need transformers == 5.0.0
    parser.add_argument(
        "--model_args",
        default= 'pretrained=/home/liuzhilei/python_project/Models/Qwen3-VL-8B-Instruct',
    ...
    parser.add_argument("--calib_data", default="coco", choices=["pileval", "coco", None])
    parser.add_argument("--n_samples", default=32, type=int) #128
    parser.add_argument("--data_path", default="data/text_data/calibration_data.json", type=str)
    parser.add_argument("--image_folder", default="data/image_data", type=str)
