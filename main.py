...
os.environ["HF_TOKEN"] = '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'
import sys
import traceback
import warnings
...
def parse_eval_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="qwen3_vl", help="Name of model e.g. `hf`")
    parser.add_argument(
        "--tasks",
        default="mmstar", #vizwiz_vqa
...
def cli_evaluate_single(args: Union[argparse.Namespace, None] = None) -> None:
    ...
    if args.pseudo_quant:
        ...
        if hasattr(lm, 'device_map') and lm.device_map != "auto" and isinstance(lm.device_map, dict):
            process_model.save_device_map(lm.device_map)
